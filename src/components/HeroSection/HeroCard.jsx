      ...
      <section className={styles.heroSection}>
        <div className={styles.hero}>
          ...
          <div className={styles.heroMovieDetails}>
            ...
            <span className={styles.filmGenre}>Adventure</span> .
            <span className={styles.filmDuration}>2h 28m</span>
          </div>
          <div className={styles.heroMovieOverview}>
            <p className={styles.heroMovieOverview}>
          ...
          <div className={styles.heroMovieButtons}>
